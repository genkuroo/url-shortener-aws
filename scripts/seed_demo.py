...
This talks to the app over HTTP, NOT directly to the database — by design. The
database lives in private subnets and is unreachable from your laptop; the only
way in is through the deployed app. That's the whole security model working as
intended.

Usage:
    # against the live load balancer
...
DEMO_LINKS = [
    ("https://www.python.org/dev/peps/pep-0008/", 5),
    ("https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Welcome.html", 3),
    ("https://developer.hashicorp.com/terraform/docs", 8),
